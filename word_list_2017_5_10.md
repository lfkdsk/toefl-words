...
| marrow        | n 精髓核心               | 2. 骨髓 narrow （狭窄的、有限的——骨缝）               |
| pith          | n 精髓                 | path 小路                                  |
|               |                      |                                          |
| lackadaisical | a 懒洋洋的               | lack 缺少 a daisy 雏菊  + cal ——  （就记住怎么写就好了） |
| lax =》        | loose 松              |                                          |
| lax           | a 松弛的 2 稀的、腹泻的       | loose —— tight 、 diarrhea                |
| slack         | a 松弛的、萧条的            | s 加强 + lack 松的松弛的 、 sl 下滑的               |
|               |                      |                                          |
| laconic       | a 简明的、简洁的            | laconia 拉哥尼亚 —— 说话简洁                     |
| pithy         | a 精炼的简洁的             | path 小路                                  |
| concise       | a 简洁的                | cis 切——剪刀                                |
| curt          | a 剪                  | 切                                        |
| terse         | a （文字） 上的简洁          | text 短信 —— terse                         |
| succinct      | a 简明的                | suc 在下面 cinct bind 绑起来 —— succeed 成功人士简洁 |
|               |                      |                                          |
| verbose       | a 啰嗦的                | ose 什么很多的 ver 动词太多                       |
| loquacious    | a 健谈的                | loq + uacious                            |
| tedious       | a 乏味又冗长的             | ted —— extend 延伸 ious 充满                 |
| garrulous     | a 喋喋不休的              | carry 带来太多的 rul 规则                       |
| prolix        | a 冗长的                | pro （向前） + lix —— liquid                 |
|               |                      |                                          |
| languid       | a 疲倦无力的、没精打采的        | lan + guid 懒鬼的                           |
| languor       | n 怠惰                 | lack                                     |
| languish      | v 失去活力               |                                          |
|               |                      |                                          |
| sluggish      | a 行动迟缓的              | slu + ggish                              |
| listless      | a 没精打采的              | list + less 没有单子（计划）                     |
|               |                      |                                          |
| lassitude     | n 疲乏                 | tude 名词后缀 lax／lazy 懒惰 —— 疲乏疲惫            |
| magnitude     | n 重大重要性、数量的代销        | magn 大的                                  |
| multitude     | n 许多、大量              | mult 许多                                  |
| fortitude     | n 坚韧                 | fort —— 力量                               |
| latitude      | n 纬度、自由              | lati                                     |
| solitude      | n 孤独、寂寞              | soli 一个人                                 |
| solicitude    | n 牵挂、关怀              | soli ci 挂念牵挂                             |
| turpitude     | n 腐化、卑鄙邪恶            | turp —— disturb  打扰                      |
| platitude     | n 陈词烂调               | banal words —— plat - flat 水平的——平淡的      |
| aptitude      | n 适应                 | ap —— adapt 适应的                          |
| vicissitude   | a 变迁                 | vi + ciss + itude vis 看到改变               |
|               |                      |                                          |
| latent        | a 潜在的、潜伏的            | latent power 潜力 、 late 潜在的东西来得晚          |
| latency       | n 等待时间、潜伏时间          |                                          |
| lateral       | a 横向的、侧面的            | later =》 side                            |
| bilateral     | a 双边的                | bi + lateral                             |
| unilateral    | a 单边的                |                                          |
| collateral    | a 旁系的、n  抵押物         | coll —— con 共同的界限                        |
|               |                      |                                          |
| leniency      | n 宽厚、仁慈              | clement 仁慈的                              |
| lenient       | a *** 宽容的            | len                                      |
| relent        | v 宽容宽恕、怜悯            | re + lent 再次借给你——宽容的人                    |
| relentless    | a 冷酷无情的              | re lent + less                           |
|               |                      |                                          |
| lethargic     | a 昏睡的、瞌睡的            | lethe 忘川河（冥界）—— Lethal                   |
| lethargy      | n 没精打采、昏昏欲睡          |                                          |
|               |                      |                                          |
| liquidate     | v 清算、结算              | liquid a 清算结算                            |
| liquefy       | vt 液化                | lique                                    |
|               |                      |                                          |
|               |                      |                                          |
|               |                      |                                          |
