...
|                         |             |                                          |
| cata = 1. down 2. fully |             |                                          |
| cataclysm               | n 灾难 大洪水    | 完全释放能量\| lys = releases                  |
| disaster                | ～           |                                          |
| catastrophe             | ～           | cata = 1. down 2. fully \| astro 星星\| phe |
|                         |             | catalogue 说                              |
| calamity                | ～           | c + alarm + ity                          |
|                         |             |                                          |
| censorious              | adj 受批判的    | censor （审查员）- censorship 审查              |
| censure                 | n/v 谴责／批评   |                                          |
| census                  | n 人口普查      |                                          |
| consensus               | n 共识一致      | con + sensus 一致                          |
|                         |             |                                          |
| cession                 | n 转让 割让     | cess \| cede \| ceed = to go （access）    |
| succeed                 | 成功 继承       | 走在下面                                     |
|                         |             | su+ 双写 =  sub                            |
| cede                    | v 割让        |                                          |
| recede                  | v 后退        | re - back                                |
| concede                 | v 妥协让步      | 妥协 \|承认 con 走到一起                         |
| accede                  | v 加入 同意     | ac + cede                                |
| precede                 | v 先于        | per                                      |
| precedent               | n 先例        |                                          |
| unprecedented           | a 史无前例的     |                                          |
| intercede               | v 说情 调停     | inter                                    |
| secede                  | v 脱离        | se                                       |
| antecede                | v 先行 超越     | ante 之前 anti 反                           |
|                         |             |                                          |
|                         |             |                                          |
|                         |             |                                          |
